...
pipeline = InferencePipeline.init(
    model_id="chess-corner-detection/1", # chess-corner-detection/1
    video_reference=1, # To Use Mobile camera stream as webcam - 1, For video use - "../media/document_6064252294466113797.mp4"
...
pipeline = InferencePipeline.init(
    ...
    video_reference="../media/document_6064252294466113797.mp4", # To Use Mobile camera stream as webcam - 1, For video use - "../media/document_6064252294466113797.mp4"
    on_prediction=my_custom_sink,
)
